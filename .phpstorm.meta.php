...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/jermashley/Projects/development/jermashley/tracking/public/storage' => 'string',
            ...
            'logging.channels.database.driver' => 'string',
            'logging.channels.database.via' => 'string',
            'logging.channels.database.level' => 'string',
            'mail.default' => 'string',
            ...
            'services.azure.client_id' => 'string',
            'services.azure.client_secret' => 'string',
            'services.azure.redirect' => 'string',
            'services.azure.tenant' => 'string',
            'services.azure.proxy' => 'NULL',
            'services.pipeline.base_url' => 'string',
            'services.pipeline.api_url' => 'string',
            'services.pipeline.api_key' => 'string',
            ...
            'socialite.valid_domains' => 'array',
            'socialite.valid_users' => 'array',
...
'filesystems.disks.spaces.driver','filesystems.disks.spaces.key','filesystems.disks.spaces.secret','filesystems.disks.spaces.endpoint','filesystems.disks.spaces.region',
'filesystems.disks.spaces.bucket','filesystems.disks.spaces.visibility','filesystems.links./Users/jermashley/Projects/development/jermashley/tracking/public/storage','logging.default','logging.deprecations.channel',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.database.driver','logging.channels.database.via','logging.channels.database.level',
...
'services.slack.notifications.channel','services.azure.client_id','services.azure.client_secret','services.azure.redirect','services.azure.tenant',
'services.azure.proxy','services.pipeline.base_url','services.pipeline.api_url','services.pipeline.api_key','session.driver',
...
'socialite.valid_domains','socialite.valid_users','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify',
...
'api.themes.store','api.themes.show','api.themes.update','api.themes.destroy','api.impersonate.stop',
'api.admin.roles.assignPermissions','api.admin.roles.index','api.admin.roles.store','api.admin.roles.show','api.admin.roles.update',
'api.admin.roles.destroy','api.admin.users.update.role','api.admin.users.index','api.admin.users.store','api.admin.users.show',
'api.admin.users.update','api.admin.users.destroy','api.admin.impersonate.start','api.admin.permissions.index','api.admin.permissions.store',
'api.admin.permissions.show','api.admin.permissions.update','api.admin.permissions.destroy','api.admin.companyApiTokens.validate','api.admin.companyApiTokens.index',
'api.admin.companyApiTokens.store','api.admin.companyApiTokens.show','api.admin.companyApiTokens.update','api.admin.companyApiTokens.destroy','api.admin.allowedDomains.toggleActiveStatus',
'api.admin.allowedDomains.index','api.admin.allowedDomains.store','api.admin.allowedDomains.show','api.admin.allowedDomains.update','api.admin.allowedDomains.destroy','home','login','admin.companies.index','admin.companies.create',
'admin.companies.show','admin.themes.index','admin.themes.create','admin.themes.show','admin.image.index',
'admin.tracking.index','admin.allowed-domains.index','admin.users.index','admin.permissions.index','admin.permissions.show',
'admin.role.index','admin.role.show','trackShipment.index','trackShipment.notFound','oauth.redirect',
'oauth.callback','oauth.logout','storage.local',);
...
'APP_DOMAIN','APP_URL','FRONTEND_URL','APP_SERVICE','VITE_APP_DOMAIN',
'ASSET_URL','SANCTUM_STATEFUL_DOMAINS','FORCE_HTTPS','FONTAWESOME_TOKEN','APP_LOCALE',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','AWS_URL','DIGITALOCEAN_SPACES_KEY',
'DIGITALOCEAN_SPACES_SECRET','DIGITALOCEAN_SPACES_ENDPOINT','DIGITALOCEAN_SPACES_REGION','DIGITALOCEAN_SPACES_BUCKET','VITE_APP_NAME',
'VITE_POSTHOG_API_HOST','VITE_POSTHOG_TOKEN','AZURE_CLIENT_ID','AZURE_CLIENT_SECRET','AZURE_REDIRECT_URI',
'AZURE_TENANT_ID','VALID_LOGIN_DOMAINS','VALID_LOGIN_USERS','PIPELINE_API_KEY','PIPELINE_BASE_URL',
'PIPELINE_API_URL','VITE_TRIMBLE_API_KEY',);
